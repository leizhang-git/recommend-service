...
import com.recommend.provider.domain.protos.Person;
...
public class SerializationUtil {
    ...
    public void protobufSerialization(Person person) throws Exception {
        FileOutputStream outputStream = new FileOutputStream(path + "protobuf-serialization.txt");
        person.writeTo(outputStream);
        outputStream.close();
    }

    public void thriftSerialization(com.recommend.provider.domain.thrift.Person person) throws Exception {
    ...
    public void hessianSerialization(com.recommend.provider.domain.Person person) throws Exception {
