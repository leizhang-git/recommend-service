...
private static final long serialVersionUID = 0L;
  ...
  protected FieldAccessorTable
    ...
    return com.recommend.provider.domain.protos.PersonProtos.internal_static_com_recommend_provider_domain_entity_Person_fieldAccessorTable
        .ensureFieldAccessorsInitialized(
            com.recommend.provider.domain.protos.Person.class, com.recommend.provider.domain.protos.Person.Builder.class);
  }
  ...
  public boolean equals(final Object obj) {
    ...
    if (!(obj instanceof com.recommend.provider.domain.protos.Person)) {
      return super.equals(obj);
    }
    com.recommend.provider.domain.protos.Person other = (com.recommend.provider.domain.protos.Person) obj;
  ...
  public static com.recommend.provider.domain.protos.Person parseFrom(
  ...
  public static com.recommend.provider.domain.protos.Person parseFrom(byte[] data)
      throws com.google.protobuf.InvalidProtocolBufferException {
    return PARSER.parseFrom(data);
  }
  public static com.recommend.provider.domain.protos.Person parseFrom(
  ...
  public static com.recommend.provider.domain.protos.Person parseFrom(java.io.InputStream input)
      throws java.io.IOException {
  ...
  public static com.recommend.provider.domain.protos.Person parseDelimitedFrom(java.io.InputStream input)
      throws java.io.IOException {
    return com.google.protobuf.GeneratedMessageV3
        .parseDelimitedWithIOException(PARSER, input);
  }

  public static com.recommend.provider.domain.protos.Person parseDelimitedFrom(
      java.io.InputStream input,
      com.google.protobuf.ExtensionRegistryLite extensionRegistry)
      throws java.io.IOException {
    return com.google.protobuf.GeneratedMessageV3
  ...
  public static final class Builder extends
      ...
      com.recommend.provider.domain.protos.PersonOrBuilder {
    public static final com.google.protobuf.Descriptors.Descriptor
        getDescriptor() {
      return com.recommend.provider.domain.protos.PersonProtos.internal_static_com_recommend_provider_domain_entity_Person_descriptor;
    }
    ...
    // Construct using com.recommend.provider.domain.protos.Person.newBuilder()
    private Builder() {
    ...
    private void buildPartial0(com.recommend.provider.domain.protos.Person result) {
    ...
    public Builder mergeFrom(com.recommend.provider.domain.protos.Person other) {
      if (other == com.recommend.provider.domain.protos.Person.getDefaultInstance()) return this;
  ...
  private static final com.recommend.provider.domain.protos.Person DEFAULT_INSTANCE;
  static {
    DEFAULT_INSTANCE = new com.recommend.provider.domain.protos.Person();
  }

  public static com.recommend.provider.domain.protos.Person getDefaultInstance() {
